//===-- SRRArchAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_SRRARCH_SRRARCHALUCODE_H
#define LLVM_LIB_TARGET_SRRARCH_SRRARCHALUCODE_H
...
const int SRRArch_PRE_OP = 0x40;
const int SRRArch_POST_OP = 0x80;

inline static unsigned encodeSRRArchAluCode(unsigned AluOp) {
...
inline static const char *srrarchAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToSRRArchAluCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_SRRARCH_SRRARCHALUCODE_H
