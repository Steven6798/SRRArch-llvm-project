...
MCSymbol *
SRRArchMCInstLower::GetGlobalAddressSymbol(const MachineOperand &MO) const {
  return Printer.getSymbol(MO.getGlobal());
}

MCSymbol *
SRRArchMCInstLower::GetBlockAddressSymbol(const MachineOperand &MO) const {
  return Printer.GetBlockAddressSymbol(MO.getBlockAddress());
}

MCSymbol *
SRRArchMCInstLower::GetExternalSymbolSymbol(const MachineOperand &MO) const {
  return Printer.GetExternalSymbolSymbol(MO.getSymbolName());
}

MCSymbol *SRRArchMCInstLower::GetJumpTableSymbol(const MachineOperand &MO) const {
...
MCSymbol *
SRRArchMCInstLower::GetConstantPoolIndexSymbol(const MachineOperand &MO) const {
  SmallString<256> Name;
...
MCOperand SRRArchMCInstLower::LowerSymbolOperand(const MachineOperand &MO,
  ...
  case SRRArchII::MO_NO_FLAG:
    Kind = SRRArch::S_None;
    break;
  case SRRArchII::MO_ABS_HI:
    Kind = SRRArch::S_ABS_HI;
    break;
  case SRRArchII::MO_ABS_LO:
