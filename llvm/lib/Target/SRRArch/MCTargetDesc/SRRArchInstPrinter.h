...
//===----------------------------------------------------------------------===//
//
// This class prints a SRRArch MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_SRRARCH_MCTARGETDESC_SRRARCHINSTPRINTER_H
#define LLVM_LIB_TARGET_SRRARCH_MCTARGETDESC_SRRARCHINSTPRINTER_H
...
#endif // LLVM_LIB_TARGET_SRRARCH_MCTARGETDESC_SRRARCHINSTPRINTER_H
