...
class SRRArchInstrInfo : public SRRArchGenInstrInfo {
  const SRRArchRegisterInfo RegisterInfo;

public:
  SRRArchInstrInfo(const SRRArchSubtarget &STI);

  // getRegisterInfo - TargetInstrInfo is a superset of MRegister info.  As
  // such, whenever a client has an instance of instruction info, it should
  // always be able to get register info as well (through this method).
  virtual const SRRArchRegisterInfo &getRegisterInfo() const {
    return RegisterInfo;
  }
  ...
  // efficient. E.g., on SRRArch register-register instructions can set the flag
