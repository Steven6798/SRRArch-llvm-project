...
#ifndef LLVM_LIB_TARGET_SRRARCH_SRRARCHCONDCODE_H
#define LLVM_LIB_TARGET_SRRARCH_SRRARCHCONDCODE_H
...
inline static StringRef srrarchCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToSRRArchCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_SRRARCH_SRRARCHCONDCODE_H
